...
define('6552612983:AAHCXtHSQZqmv515XrMDz6JNlcBga66ByLs',"LITE_TOKEN");

$builder24 = "LITE_ID";
$admins=file_get_contents("statistika/admins.txt");
$admin = explode("\n", $admins);
array_push($admin,$builder24);
$xostfile = "CreateMaker";
...
$txolat=json_decode(file_get_contents("https://m1953.myxvest.ru/$xostfile/foydalanuvchi/$adminid/$botnomi/foydalanuvchi/$builder24/$botname/kunlik.tolov"));
$kun = $txolat->kun;
$times = "$sana — $soat";
...
$get = json_decode(file_get_contents("https://api.telegram.org/bot$tx/setwebhook?url=https://".$_SERVER['SERVER_NAME']."/$xostfile/foydalanuvchi/$adminid/$botnomi/foydalanuvchi/$builder24/$botname/foydalanuvchi/$cid/$botuser/$turi.php"))->result;
if($get){
$botuser = json_decode(file_get_contents("https://api.telegram.org/bot$tx/getme"))->result->username;
